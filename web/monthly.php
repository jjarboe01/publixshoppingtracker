    ...
    <div class="container">
        ...
        <nav>
            <div class="nav-buttons">
                <a href="index.php" class="btn btn-secondary">← Back to Dashboard</a>                <a href="trips.php" class="btn btn-primary">🛍️ Shopping Trips</a>                <a href="top-items.php" class="btn btn-primary">🏆 Top Items</a>
